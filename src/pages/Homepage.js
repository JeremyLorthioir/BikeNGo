...
export default function Homepage() {
    ...
    return ( 
        <div className={'homepage'}>
            {/* HEADER PICTURE */}
            <img className={'image'} src={require('../img/homepage-main-picture.png')}/>
            ...
            <Grid direction='row' container className={'cardContainer'}>
                <Grid direction='column' className={'card'} sm={2}>
                    <div className={'cardImageContainer'}>
                        <img className={'cardImage'} src={require('../img/homepage-firecamp-icon.png')} />
                    </div>
                ...
                <Grid direction='column' className={'card'} sm={2}>
                    <div className={'cardImageContainer'}>
                        <img className={'cardImage'} src={require('../img/homepage-ticket-icon.png')} />
                    </div>
                ...
                <Grid direction='column' className={'card'} sm={2}>
                    <div className={'cardImageContainer'}>
                        <img className={'cardImage'} src={require('../img/homepage-paper-icon.png')} />
                    </div>
                ...
                <Grid direction='column' className={'card'} sm={2}>
                    <div className={'cardImageContainer'}>
                        <img className={'cardImage'} src={require('../img/homepage-gear-icon.png')} />
                    </div>
            ...
            <Grid direction='column' container className={'lovedContentContainer cardContainer'}>
                <img src={require('../img/site-icon.png')} className={'lovedContentImage'} />
