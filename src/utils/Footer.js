			...
			<Grid className={classes.footer} container>
				<Grid md="4">
					...
					<Typography
						...
						component="p"
					>
						Que votre pratique soit occasionnelle, confirmée ou professionnelle
						vous trouverez toujours ce qu’il vous faut ici ! Laissez-vous guider
						en toute confiance par la selection de nos experts.
					</Typography>
				</Grid>
				<Grid md="4">
					<Typography variant="h6" align="center" gutterBottom>
